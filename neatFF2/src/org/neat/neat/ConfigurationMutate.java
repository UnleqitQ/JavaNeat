...
public class ConfigurationMutate {
	...
	public float averageAddNodesPerMutate = 1.0f;
	public float averageAddExistingNodesPerMutate = 1.0f;
	public float averageAddConnectionsPerMutate = 1.0f;
	public float averageNewNodesAggregatonPerMutate = 0.1f;
	public float averageNewNodesActivationPerMutate = 0.1f;
	public float averageToggleConnectionsPerMutate = 1.0f;
	public float averageToggleNodesPerMutate = 1.0f;
